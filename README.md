...
### AI 工具可以随便来，硬盘里的残留得有人管。

AI 工具每天都在冒出来，像一群不请自来的室友：用完工具就走，缓存、会话、快照、日志、
模型和配置却全留在硬盘里。它们散落在不同目录，安静地占空间，直到某天磁盘突然告急，
你还不知道是谁干的。

AICensus 把这些“硬盘残局”找出来，按工具、类别和风险盘点，记录每天和每小时的变化，
让你看清谁在占空间、占了什么、增长得快不快。先把账算清楚，后面清理才不容易误伤。

> AI 工具天天来，硬盘天天“吃不消”。先抓现行，再收拾它们。
